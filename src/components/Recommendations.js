...
const Recommendations = (props) => {
    ...
    const Featured_API = `https://api.themoviedb.org/3/movie/${id}/recommendations?api_key=396396a62b712667981a8f668ce12839&language=en-US&page=1`
    ...
    useEffect(() => {
      ...
      return (
        <Carousel responsive={responsive}>
          ...
          <Link to={`/details/${r.id}`}><div key={'recommendation'+ r.id} className='movie'>
            <img src={
